 ...
 *
 * Mirrors data/art/manifest.yaml's `dice_faces` block. The server does not send
 * an image url with `dice_result` and shipped.py has no `kind == "dice"`
 * branch, so the client resolves the path itself; tests/test_dice_art.py holds
 * the two in step.
 */
...
// about two thirds of a second a player who has read the number already is
